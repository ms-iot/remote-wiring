...
namespace Wiring {
	...
	namespace I2C {
		...
		private:
			...
			{
				_i2cReplyCallback = nullptr;
				_firmata->I2cCallbackEvent += ref new Wiring::Firmata::I2cReplyCallbackFunction( [this]( Wiring::Firmata::UAPFirmataClient ^caller, Wiring::Firmata::I2cCallbackEventArgs^ args ) -> void { onI2cReply( args ); } );
			}
			...
			void onI2cReply( Wiring::Firmata::I2cCallbackEventArgs ^argv );
